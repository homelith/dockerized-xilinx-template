...
set IPS_TO_BE_UPGRADED "pl_system_P9PZLU1"
...
upgrade_ip [ get_ips {pl_system_P9PZLU1} ] -log ip_upgrade.log
export_ip_user_files -of_objects [ get_ips {pl_system_P9PZLU1} ] -no_script -sync -force -quiet
