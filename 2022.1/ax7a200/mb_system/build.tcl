...
exec updatemem -force \
    ...
    -out workspace/pl_system_wrapper_with_elf.bit
exec vivado -mode batch -source generate_mcs.tcl -tclargs workspace/pl_system_wrapper_with_elf.bit workspace/pl_system_wrapper_with_elf.mcs
