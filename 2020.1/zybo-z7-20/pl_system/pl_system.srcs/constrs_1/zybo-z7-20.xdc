...
################################################################################
# golden top xdc for digilent ZYBO Z7-20 development board
#  - port names are derived from "zybo_z7_sch-public.pdf"
...
##Buttons
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {BTN[0]}]; #IO_L12N_T1_MRCC_35 Sch=BTN0
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports {BTN[1]}]; #IO_L24N_T3_34 Sch=BTN1
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33} [get_ports {BTN[2]}]; #IO_L10P_T1_AD11P_35 Sch=BTN2
...
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { jb[3] }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]
