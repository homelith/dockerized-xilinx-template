...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net intx_M00_AXI [get_bd_intf_pins gpio/S_AXI] [get_bd_intf_pins intx/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps_M_AXI_GP0 [get_bd_intf_pins intx/S00_AXI] [get_bd_intf_pins ps/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net ps_FCLK_CLK0 [get_bd_pins gpio/s_axi_aclk] [get_bd_pins intx/ACLK] [get_bd_pins intx/M00_ACLK] [get_bd_pins intx/S00_ACLK] [get_bd_pins ps/FCLK_CLK0] [get_bd_pins ps/M_AXI_GP0_ACLK] [get_bd_pins rstgen/slowest_sync_clk]
  connect_bd_net -net ps_FCLK_RESET0_N [get_bd_pins ps/FCLK_RESET0_N] [get_bd_pins rstgen/ext_reset_in]
  connect_bd_net -net rstgen_interconnect_aresetn [get_bd_pins intx/ARESETN] [get_bd_pins rstgen/interconnect_aresetn]
  connect_bd_net -net rstgen_peripheral_aresetn [get_bd_pins gpio/s_axi_aresetn] [get_bd_pins intx/M00_ARESETN] [get_bd_pins intx/S00_ARESETN] [get_bd_pins rstgen/peripheral_aresetn]
...
proc create_hier_cell_mb_system { parentCell nameHier } {
  ...
  connect_bd_net -net clk [get_bd_pins clk] [get_bd_pins gpio/s_axi_aclk] [get_bd_pins intc/processor_clk] [get_bd_pins intc/s_axi_aclk] [get_bd_pins intx/ACLK] [get_bd_pins intx/M00_ACLK] [get_bd_pins intx/M01_ACLK] [get_bd_pins intx/M02_ACLK] [get_bd_pins intx/S00_ACLK] [get_bd_pins localmem/clk] [get_bd_pins mb/Clk] [get_bd_pins mdm/S_AXI_ACLK] [get_bd_pins rstgen/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {arst_n} \
 ] $sys_clk
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DDR [get_bd_intf_ports DDR] [get_bd_intf_pins ps_system/DDR]
  connect_bd_intf_net -intf_net FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins ps_system/FIXED_IO]
  connect_bd_intf_net -intf_net mb_gpio [get_bd_intf_ports mb_gpio] [get_bd_intf_pins mb_system/gpio]
  connect_bd_intf_net -intf_net ps_gpio [get_bd_intf_ports ps_gpio] [get_bd_intf_pins ps_system/gpio]

  # Create port connections
  connect_bd_net -net arst_n [get_bd_ports arst_n] [get_bd_pins blink_0/arst_n] [get_bd_pins hls_system/arst_n] [get_bd_pins mb_system/arst_n]
  connect_bd_net -net blink_0_gpio_out [get_bd_ports rtl_gpio] [get_bd_pins blink_0/gpio_out]
  connect_bd_net -net hls_gpio [get_bd_ports hls_gpio] [get_bd_pins hls_system/gpio]
  connect_bd_net -net sys_clk [get_bd_ports sys_clk] [get_bd_pins blink_0/clk] [get_bd_pins hls_system/clk] [get_bd_pins mb_system/clk]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_system/ps/Data] [get_bd_addr_segs ps_system/gpio/S_AXI/Reg] -force
